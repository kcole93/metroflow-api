...
export interface StaticTripInfo {
  ...
  direction_id?: number // 0 or 1, often indicates direction (e.g., Uptown/Downtown)
  block_id?: string
...
export interface StaticData {
  ...
  /** Map where key is route_id, value contains an array of feed URLs. */
  routeFeedMap: Map<string, string[]>
